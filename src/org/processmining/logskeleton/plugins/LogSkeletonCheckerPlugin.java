...
@Plugin(name = "Filter Event Log on Log Skeleton", parameterLabels = { "Log Skeleton", "Event log"}, returnLabels = { "Filtered Event Log" }, returnTypes = { XLog.class }, userAccessible = true, help = "Filter Event Log on Log Skeleton")
