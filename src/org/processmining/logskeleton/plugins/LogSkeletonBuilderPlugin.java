...
@Plugin(name = "Build Log Skeleton from Event Log", parameterLabels = { "Event log"}, returnLabels = { "Log Skeleton" }, returnTypes = { LogSkeleton.class }, userAccessible = true, help = "Create Log Skeleton from Event Log")
